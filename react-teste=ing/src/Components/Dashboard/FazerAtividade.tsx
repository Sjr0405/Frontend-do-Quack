      ...
      <MainContent>
        ...
        <EditorContainer>
          <Editor
            ...
            theme="vs-dark"
            value={userCode}
            onChange={(value) => !isSubmitted && setUserCode(value || '')} // Permite edição apenas se não foi enviado
            options={{ readOnly: isSubmitted }} // Define como somente leitura se o código foi enviado
          />
        </EditorContainer>
